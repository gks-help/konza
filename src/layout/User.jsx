...
import AuthNavbar from "../components/user/header.jsx";
import AuthFooter from "../components/user/footer.jsx";
...
export default class User extends React.Component {
  ...
  componentDidMount() {
    ...
    if(sessionStorage.getItem('userDB')){
      ...
      this.props.history.push({ pathname: `/auth/login`, search: '?Logout=true'});
    }
    ...
    <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
      ...
      <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
          {/* <a href="demo1/index.html"> <img alt="Logo" src="/assets/konza-logo-wht.png" /> </a> */}
          <a> <img alt="Logo" src="http://clienttesting.cc/konza/assets/thumbnail_konza_logo_RGB.png"  style={{"width":"150px"}}/> </a>
        </div>
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
              ...
              <div class="kt-notification">
                ...
                <div class="kt-notification__custom kt-space-between">
                  <a 
                   target="_blank" class="btn btn-label btn-label-brand btn-sm btn-bold"
    ...
    <div class="kt-demo-panel__item kt-demo-panel__item--active">
      ...
      <div class="kt-demo-panel__item-preview">
        ...
        <div class="kt-demo-panel__item-preview-overlay">
          <a class="btn btn-brand btn-elevate " target="_blank">Preview</a>
        </div>
      </div>
    </div>
