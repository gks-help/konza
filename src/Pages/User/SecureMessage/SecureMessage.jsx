...
import MailCard from '../../comman/MailCard.jsx'
...
export default class SecureMessage extends React.Component {
          ...
          <div class="kt-portlet kt-portlet--mobile  col-md-12"  style={{"padding":"0px"}}>
            ...
            <div class="col-md-4"  style={{"padding":"0px"}}> 
                ...
                <div class="row" style={{"padding":"10px"}}>
                    <div class="col-md-9">
                        <button type="reset" class="btn btn-primary" onClick={this.SecureSetting} style={{ "border-color": "#fff", "background-color": "#fff", "padding": "0", "color": "#000" }} > <i class="flaticon-settings"></i>   </button>
                    </div>
                    <div class="col-md-3">
                        <button type="reset" class="btn btn-primary" onClick={this.new} style={{ "background-color": "#fff", "color": "#000" }} > New </button> &nbsp;
                    </div>
                </div>
